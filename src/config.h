...
// ---- MQTT broker ----
#define MQTT_HOST "morninglow.nl"
#define MQTT_PORT 9883
#define MQTT_USER "esp32user"
#define MQTT_PASS "esp32password"
#define MQTT_CLIENT_ID "esp32-client-1"
...
#define MQTT_RETRY_INTERVAL   2000
#define LED_FADE_INTERVAL     1     // ms between fade steps
#define LED_FADE_STEP         8     // brightness change per step
